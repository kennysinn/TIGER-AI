...
navLinks.forEach((link) => {
  ...
  const isUserDashboardPage = currentPage.includes("dashboard") && href === "user-dashboard.html";
  const isEmployeePage = currentPage.startsWith("employee-") && href === "employees.html";
  const isCompanyPage = ["business-kit.html", "demo-link.html"].includes(currentPage) && href === "company.html";
  const isConsultantPage = currentPage === "diagnosis-result.html" && href === "consultant.html";
  if (href === currentPage || isDashboardPage || isUserDashboardPage || isEmployeePage || isCompanyPage || isConsultantPage || (currentPage === "" && href === "index.html")) {
...
Object.assign(languageText, {
  ...
  "AI Employees": "AI 员工",
  "Start free": "免费开始",
  "AI Company Consultant": "AI 公司顾问",
  "Not sure what AI business to start?": "不知道要开始什么 AI 生意？",
  "Start with a free prompt-based consultant. Tiger AI helps you find a direction first. When you are ready, form the company and assign AI employees.": "先用免费的 prompt 顾问找方向。方向清楚后，再生成公司蓝图并配置 AI 员工。",
  "Start free diagnosis": "开始免费诊断",
  "View company workspace": "查看公司工作台",
  "Free diagnosis preview": "免费诊断预览",
  "I want to start an AI business, but I do not know what to build.": "我想开始 AI 生意，但不知道该做什么。",
  "Recommended direction": "推荐方向",
  "Best for a sales-driven beginner founder with SME contacts.": "适合会销售、认识 SME 老板的新手 founder。",
  "First offer": "第一个服务",
  "AI employees": "AI 员工",
  "3 assigned": "已配置 3 个",
  "Simple product flow": "简单产品流程",
  "Free direction first. Paid company formation after.": "先免费定方向，之后才付费生成公司。",
  "AI Consultant": "AI 顾问",
  "Ask questions, diagnose founder fit, recommend a business direction.": "提问、诊断 founder 适配度、推荐商业方向。",
  "Form Company": "生成公司",
  "Turn direction into company blueprint, service package, and launch plan.": "把方向变成公司蓝图、服务配套和启动计划。",
  "Assign roles, define jobs, and prepare the training checklist.": "配置角色、定义工作、准备训练清单。",
  "Pricing logic": "收费逻辑",
  "Diagnosis is free. Company formation is where paid value starts.": "诊断免费。生成公司开始才是付费价值。",
  "Founder Diagnosis": "Founder 诊断",
  "Form Company + AI Employees": "生成公司 + AI 员工",
  "From confused founder to one-person AI company.": "从迷茫 founder 到一人 AI 公司。",
  "Free entry": "免费入口",
  "Use this like a GPT-style business consultant. No company is formed yet.": "像 GPT 顾问一样使用。这里还不会真正生成公司。",
  "I have SME contacts": "我认识 SME 老板",
  "I can sell but cannot code": "我会销售但不会写 code",
  "I want a side business": "我想做副业",
  "I need a first offer": "我需要第一个服务",
  "Ask Tiger AI what business you should build.": "问 Tiger AI 你适合做什么生意。",
  "Static preview": "静态预览",
  "Tell me your skills, network, time, and the customers you can reach. I will recommend a practical AI business direction.": "告诉我你的技能、人脉、时间和能接触的客户。我会推荐一个实际可做的 AI 生意方向。",
  "I am good at talking to business owners. I know some SME bosses, but I am not technical. I can spend 8 hours per week.": "我擅长和老板沟通，认识一些 SME 老板，但我不懂技术。每周可以投入 8 小时。",
  "Founder Type": "Founder 类型",
  "Sales-driven beginner founder": "销售型新手 founder",
  "Recommended Direction": "推荐方向",
  "Best First Offer": "最佳第一个服务",
  "Next Step": "下一步",
  "Form the company blueprint": "生成公司蓝图",
  "Ask Tiger AI": "询问 Tiger AI",
  "Free diagnosis first. Company formation comes after direction is clear.": "先免费诊断。方向清楚后再生成公司。",
  "Paid formation preview": "付费生成预览",
  "Form your AI company.": "生成你的 AI 公司。",
  "This page shows what happens after the free diagnosis. No payment is connected yet.": "这个页面展示免费诊断之后的流程。目前还没有连接付款。",
  "Company Blueprint": "公司蓝图",
  "Help SMEs reply faster, qualify enquiries, and hand over serious leads to sales.": "帮助 SME 更快回复、筛选询问，并把高意向线索交给销售。",
  "View AI employees": "查看 AI 员工",
  "Open dashboard": "打开仪表盘",
  "Target Customer": "目标客户",
  "Service businesses with WhatsApp enquiries": "有 WhatsApp 询问的服务型公司",
  "Pricing Direction": "建议收费模式",
  "Suggested Pricing Model": "建议收费模式",
  "Business Kit": "商业工具包",
  "Proposal, outreach script, onboarding form, monthly report": "Proposal、开发话术、onboarding 表格、月报",
  "7-day launch plan": "7 天启动计划",
  "First week execution": "第一周执行",
  "Define one target industry": "确定一个目标行业",
  "Prepare a simple demo story": "准备简单 demo 叙事",
  "Interview 5 SME owners": "访问 5 位 SME 老板",
  "Send 10 outreach messages": "发出 10 条开发信息",
  "Share demo and collect objections": "分享 demo 并收集异议",
  "Send first proposal": "发出第一份 proposal",
  "Follow up and refine offer": "跟进并优化服务",
  "Company readiness": "公司准备度",
  "What is ready": "目前准备好了什么",
  "Blueprint": "蓝图",
  "Ready": "已准备",
  "AI employee roles": "AI 员工角色",
  "Knowledge": "知识资料",
  "Needs client details": "需要客户资料",
  "Demo link": "演示链接",
  "Preview only": "仅预览",
  "Form company is the paid step after free direction.": "免费定方向后，生成公司才是付费步骤。",
  "AI Employee Studio": "AI 员工工作室",
  "Train the roles assigned by Tiger AI.": "训练 Tiger AI 配置好的角色。",
  "For now this is a polished frontend preview. Real training and chat will come later.": "目前这是前端预览。真实训练和聊天之后再开发。",
  "AI First Responder": "AI 第一回复员",
  "AI Lead Qualifier": "AI 线索筛选员",
  "AI Sales Handover Assistant": "AI 销售交接助手",
  "AI Proposal Writer": "AI Proposal 写手",
  "Selected employee": "当前员工",
  "72% ready": "72% 已准备",
  "Main job": "主要工作",
  "Reply to new enquiries quickly, ask basic questions, and keep the prospect engaged.": "快速回复新询问，提出基础问题，并保持客户互动。",
  "Must collect": "必须收集",
  "Name, need, budget range, timeline, location, preferred contact method.": "名字、需求、预算范围、时间、地点、偏好联系方式。",
  "Handover rule": "交接规则",
  "Send hot leads to the founder when the prospect has budget and urgency.": "当客户有预算和急迫性时，把高意向线索交给 founder。",
  "Tone": "语气",
  "Helpful, fast, professional, simple English or Chinese.": "有帮助、快速、专业，使用简单英文或中文。",
  "Knowledge needed": "需要的知识",
  "Service details": "服务详情",
  "Pricing rules": "价格规则",
  "FAQ": "常见问题",
  "Booking rules": "预约规则",
  "Service area": "服务区域",
  "Human contact": "人工联系方式",
  "Employee instructions": "员工指令",
  "Answer quickly. Ask one question at a time. Do not invent pricing. Hand over hot leads to the founder.": "快速回答。一次只问一个问题。不要编造价格。把高意向线索交给 founder。",
  "Save employee draft": "保存员工草稿",
  "AI employees become roles inside a sellable service package.": "AI 员工会成为可销售服务配套里的角色。",
  "Back to consultant": "回到顾问",
  "Your best starting direction.": "你最适合的起步方向。",
  "This is a static simulated result. Later it will be generated from the founder interview.": "这是静态模拟结果。之后会根据 founder 访谈生成。",
  "Diagnosis Result": "诊断结果",
  "Company Blueprint": "公司蓝图",
  "Demo Link": "演示链接",
  "Recommended path": "推荐路径",
  "Risk": "风险",
  "Needs simple delivery system, not complex software": "需要简单交付系统，不是复杂软件",
  "Why this direction": "为什么是这个方向",
  "SME owners understand slow enquiry response quickly. The offer is easy to explain, easy to demo, and does not require deep technical setup for the first version.": "SME 老板很容易理解回复慢的问题。这个服务容易解释、容易 demo，第一版不需要复杂技术。",
  "Form this company": "生成这间公司",
  "Try another prompt": "换一个 prompt",
  "Direction is free. Company formation is the next step.": "方向免费。下一步才是生成公司。",
  "All employees": "全部员工",
  "Next employee": "下一个员工",
  "Previous": "上一个",
  "AI Employee Detail": "AI 员工详情",
  "The first reply role for a Speed-to-Lead AI Company.": "Speed-to-Lead AI Company 的第一回复角色。",
  "Reply fast and keep the prospect engaged.": "快速回复并保持客户互动。",
  "Collect": "收集",
  "Do not": "不要做",
  "Do not invent price, guarantee outcomes, or answer outside the service scope.": "不要编造价格、保证结果，或回答服务范围外的问题。",
  "Sample instruction": "指令示例",
  "Continue to Lead Qualifier": "继续到线索筛选员",
  "Preview demo link": "预览演示链接",
  "This role turns a casual enquiry into useful sales information.": "这个角色把普通询问变成有用的销售信息。",
  "Ask the right questions before sales follows up.": "在销售跟进前问对问题。",
  "Qualify by": "筛选依据",
  "Lead status": "线索状态",
  "Output": "输出",
  "Continue to Sales Handover": "继续到销售交接",
  "Back to company": "回到公司",
  "This role prepares clean handover notes for the founder or sales team.": "这个角色为 founder 或销售团队准备清晰的交接摘要。",
  "Turn chats into clean sales handover summaries.": "把聊天整理成清晰的销售交接摘要。",
  "Sales action": "销售动作",
  "Founder view": "Founder 视角",
  "Continue to Proposal Writer": "继续到 Proposal 写手",
  "This role converts the company offer into a client-ready proposal outline.": "这个角色把公司服务转换成客户可读的 proposal 大纲。",
  "Create a clean first proposal from the service package.": "根据服务配套创建第一份清晰 proposal。",
  "Proposal sections": "Proposal 结构",
  "Pricing use": "价格使用",
  "Generate business kit": "生成商业工具包",
  "Business kit": "商业工具包",
  "Package the AI company into a sellable offer.": "把 AI 公司包装成可以销售的服务。",
  "Static preview of the assets Tiger AI will generate after company formation.": "静态预览 Tiger AI 在公司生成后会创建的资产。",
  "Generated assets": "生成的资产",
  "Pricing package": "价格配套",
  "WhatsApp script": "WhatsApp 话术",
  "Onboarding form": "Onboarding 表格",
  "Monthly report": "月报",
  "Demo script": "Demo 话术",
  "Preview client demo": "预览客户 demo",
  "Open command desk": "打开控制台",
  "Business kit turns AI employees into a service package.": "商业工具包把 AI 员工变成服务配套。",
  "Create demo link": "创建演示链接",
  "Client Demo Link": "客户演示链接",
  "A shareable page for your prospect.": "一个可以发给潜在客户的页面。",
  "This is a static preview. Later each company will generate its own public demo URL.": "这是静态预览。之后每间公司都会生成自己的公开 demo URL。",
  "Prospect sees": "客户看到",
  "What it does": "它能做什么",
  "Replies to enquiries, asks qualifying questions, and hands over serious leads.": "回复询问、提出筛选问题，并交接高意向线索。",
  "Readiness": "准备度",
  "Demo ready with sample FAQ and handover rule.": "已用示例 FAQ 和交接规则准备 demo。",
  "Founder gets": "Founder 得到",
  "Proposal request, missing info feedback, follow-up signal.": "Proposal 请求、缺失资料反馈、跟进信号。",
  "Request proposal": "请求 proposal",
  "Edit company": "编辑公司",
  "Client demo preview": "客户 demo 预览"
});

Object.assign(languageText, {
  "AI Company Consultant": "AI 公司顾问",
  "Not sure what AI business to start?": "不知道要做什么 AI 生意？",
  "Tiger AI gives you an AI Company Consultant that asks the right questions, diagnoses your founder profile, recommends a business direction, assigns AI employees, and generates your first company blueprint.": "Tiger AI 给你一个 AI 公司顾问：它会问对问题、诊断你的 founder profile、推荐商业方向、配置 AI 员工，并生成第一份公司蓝图。",
  "Start founder diagnosis": "开始 founder 诊断",
  "See how it works": "查看运作方式",
  "AI Company Consultant Interview": "AI 公司顾问访谈",
  "Founder Diagnosis": "Founder 诊断",
  "Direction Match": "方向匹配",
  "Company Blueprint": "公司蓝图",
  "AI Employees": "AI 员工",
  "7-Day Plan": "7 天计划",
  "Founder input": "Founder 输入",
  "\"I want to start an AI business, but I don't know what to build.\"": "“我想开始 AI 生意，但不知道要做什么。”",
  "Consultant Output": "顾问输出",
  "Sales-driven beginner founder": "销售驱动的新手 founder",
  "Recommended direction: Speed-to-Lead AI Company for SME enquiry response.": "推荐方向：为 SME 询盘回应打造 Speed-to-Lead AI 公司。",
  "First Responder, Lead Qualifier, Handover Assistant": "第一回应员、客户筛选员、交接助理",
  "First Offer": "第一个 offer",
  "AI Enquiry Response System": "AI 询盘回应系统",
  "Demo, proposal, onboarding, monthly report": "演示、proposal、onboarding、月报",
  "Diagnose": "诊断",
  "Blueprint": "蓝图",
  "Guided from zero": "从零开始引导",
  "How Tiger AI guides you from zero.": "Tiger AI 如何从零引导你。",
  "Answer a guided interview. Tiger AI builds your company blueprint, AI employees, business kit, and execution plan.": "回答一组引导式问题。Tiger AI 会生成公司蓝图、AI 员工、商业工具包和执行计划。",
  "Answer founder questions": "回答 founder 问题",
  "Skills, experience, network, time, and business interest.": "技能、经验、人脉、时间和商业兴趣。",
  "Get your founder profile": "获得 founder profile",
  "Founder type, strengths, gaps, and best starting path.": "Founder 类型、强项、短板和最佳起步路径。",
  "Choose your business direction": "选择商业方向",
  "Match your profile to a business pain and market opportunity.": "把你的 profile 匹配到商业痛点和市场机会。",
  "Assign AI employees": "配置 AI 员工",
  "Get the roles needed to deliver your first service offer.": "获得交付第一个服务 offer 所需的 AI 角色。",
  "Generate your business kit": "生成商业工具包",
  "Proposal, pricing, WhatsApp script, onboarding, and report.": "Proposal、价格、WhatsApp 话术、onboarding 和报告。",
  "Launch with a 7-day plan": "用 7 天计划启动",
  "Daily tasks to interview prospects, build demo, and send offers.": "每天执行任务：访问潜在客户、建立 demo、发送 offer。",
  "First, Tiger AI helps the founder stop guessing.": "首先，Tiger AI 帮 founder 停止瞎猜。",
  "The consultant asks about you, your market, your network, and the first business model you can realistically execute.": "顾问会了解你、市场、人脉，以及你最现实可以执行的第一个商业模式。",
  "Questions": "问题",
  "What Tiger AI asks": "Tiger AI 会问什么",
  "Your skills": "你的技能",
  "Your experience": "你的经验",
  "Your network": "你的人脉",
  "Available time": "可投入时间",
  "Target market": "目标市场",
  "Customer pain points": "客户痛点",
  "Business model preference": "商业模式偏好",
  "Output": "输出",
  "What Tiger AI generates": "Tiger AI 会生成什么",
  "Founder profile and risk warnings": "Founder profile 和风险提醒",
  "Recommended AI company type": "推荐 AI 公司类型",
  "Business model and pricing direction": "商业模式和价格方向",
  "AI employee team and training checklist": "AI 员工团队和训练清单",
  "Next action plan for the first 7 days": "前 7 天下一步行动计划",
  "After diagnosis": "诊断之后",
  "Choose a direction after your founder diagnosis.": "完成 founder 诊断后选择方向。",
  "Each direction turns a founder profile into an AI company type, recommended AI employees, service package, demo flow, and business kit.": "每个方向都会把 founder profile 转成 AI 公司类型、推荐 AI 员工、服务配套、演示流程和商业工具包。",
  "Not sure which template fits you?": "不确定哪个模板适合你？",
  "Start with Founder Diagnosis first, then use the recommendation to choose your AI company direction.": "先从 Founder Diagnosis 开始，再根据推荐选择 AI 公司方向。",
  "Built from consultant output:": "根据顾问输出建立：",
  "01 Diagnosis": "01 诊断",
  "02 Blueprint": "02 蓝图",
  "Founder Profile": "Founder Profile",
  "Consultant diagnosis summary": "顾问诊断摘要",
  "Founder type": "Founder 类型",
  "Strength": "强项",
  "Client communication and networking": "客户沟通和人脉建立",
  "Weakness": "短板",
  "Technical delivery and system setup": "技术交付和系统设置",
  "Best path": "最佳路径",
  "AI service business with simple partner fulfillment": "AI 服务生意，搭配简单 partner 交付",
  "Define the offer from the consultant output.": "根据顾问输出定义 offer。",
  "Turn the recommended business direction into a clear company name, target customer, first offer, pricing direction, and handover rule.": "把推荐商业方向转成清楚的公司名称、目标客户、第一个 offer、价格方向和交接规则。",
  "Train the AI employees assigned by your consultant.": "训练顾问为你配置的 AI 员工。",
  "The consultant assigns the first roles needed to deliver your offer. Your job is to train them with business knowledge.": "顾问会配置交付 offer 所需的第一批角色。你的任务是用业务知识训练他们。",
  "7-day execution plan.": "7 天执行计划。",
  "Day 1: define target customer": "第 1 天：定义目标客户",
  "Day 2: prepare demo script": "第 2 天：准备演示脚本",
  "Day 3: contact 10 prospects": "第 3 天：联系 10 个潜在客户",
  "Day 4: run 3 discovery calls": "第 4 天：进行 3 场 discovery call",
  "Day 5: generate proposal": "第 5 天：生成 proposal",
  "Day 6: follow up": "第 6 天：跟进",
  "Day 7: close first pilot": "第 7 天：成交第一个 pilot",
  "Founder-ready demo link": "Founder-ready 演示链接",
  "Your founder-ready demo link.": "你的 founder-ready 演示链接。",
  "Show the company direction, AI employee team, service package, demo chat, and proposal request path in one shareable page.": "在一个可分享页面展示公司方向、AI 员工团队、服务配套、演示聊天和 proposal 请求路径。",
  "Founder sales asset": "Founder 销售资产",
  "Share the first proof of your AI company.": "分享你 AI 公司的第一份证明。",
  "This page helps a prospect understand the direction, test the AI employee, and request a proposal before you build a full client portal.": "这个页面让潜在客户在完整客户后台完成前，先理解方向、测试 AI 员工并请求 proposal。",
  "Company direction": "公司方向",
  "AI employee team": "AI 员工团队",
  "Founder next steps": "Founder 下一步",
  "Knowledge gaps to fix": "需要补齐的知识缺口",
  "Command Desk progress update": "控制台进度更新",
  "Execution progress": "执行进度",
  "From idea to first AI company: 42% complete": "从想法到第一间 AI 公司：完成 42%",
  "Next milestone: share the demo link and collect the first proposal request.": "下一个里程碑：分享演示链接并收集第一个 proposal 请求。",
